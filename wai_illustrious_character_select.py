...
wai_illustrious_character_select_files = [       
    ...
    {'name': 'wai_character', 'file_path': os.path.join(json_folder, 'wai_characters.csv'), 'url':'https://raw.githubusercontent.com/R0smontis/ComfyUI_Mira/refs/heads/fix/arknights-endfield-wuwa-zzz-characters/json/wai_characters.csv'}
]
